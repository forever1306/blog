...
?>
<!-- ========== Latest Posts ========== -->
<div class="section frontpage-recent-posts <?php echo esc_attr($vega_wp_curr_bg) ?>" id="<?php echo esc_attr($vega_wp_frontpage_latest_posts_section_id) ?>" <?php  vega_wp_section_bg_color('vega_wp_frontpage_latest_posts_bg_color'); ?>>
    <div class="container">
