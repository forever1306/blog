...
?>
<!-- ========== Featured Section ========== -->
<div class="section frontpage-open1 <?php echo esc_attr($vega_wp_curr_bg) ?>" id="<?php echo esc_attr($vega_wp_frontpage_open1_section_id) ?>" <?php vega_wp_section_bg_color('vega_wp_frontpage_open1_bg_color'); ?>>
    <div class="container">
