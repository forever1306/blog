            ...
            <div class="<?php echo $col1_class ?>">
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
                    ...
                    <div class="entry-meta">
                        <?php if($vega_wp_post_meta_date == 'Y') { $date_format = get_option('date_format'); $temp[] = __('Posted: ', 'vega') . get_the_date($date_format); } ?>
                        <?php if($vega_wp_post_meta_category == 'Y') { $temp[] = __('Under: ', 'vega'). get_the_category_list(', '); } ?>
                        <?php if($vega_wp_post_meta_author == 'Y') { $temp[] = __('By: ', 'vega')  . get_the_author();  } ?>
